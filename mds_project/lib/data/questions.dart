...
final questions = [
  Question(
    ...
    selectedOption: Option(code: 'A', text: 'Earth', isCorrect: false),
  ),
  Question(
    ...
    selectedOption: Option(code: 'A', text: '1', isCorrect: false),
  ),
  Question(
  ...
  Question(
    ...
    selectedOption: Option(code: 'B', text: 'Hamilton', isCorrect: false),
  ),
  Question(
    ...
    selectedOption: Option(code: 'B', text: '2008', isCorrect: false),
  ),
  Question(
    ...
    selectedOption: Option(code: 'B', text: 'Oxygen', isCorrect: false),
  ),
  Question(
    ...
    selectedOption: Option(code: 'B', text: 'Germany', isCorrect: false),
  ),
];
